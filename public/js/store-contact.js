...
function renderCustomerDrawerFooter() {
  ...
  footer.innerHTML = `
    <div class="space-y-3 font-sans">
      ...
      <!-- Contact Us Header & Social Icons Row -->
      <div class="space-y-2 px-1">
        ...
        <div class="flex items-center gap-2.5">
          ...
          <!-- Instagram Icon (Display Only) -->
          <div title="Instagram (Coming Soon)"
               class="w-10 h-10 rounded-xl bg-[#E1306C]/10 border border-[#E1306C]/20 text-[#E1306C]/70 flex items-center justify-center cursor-default select-none shadow-sm">
          ...
          <!-- Discord Icon (Display Only) -->
          <div title="Discord Community (Coming Soon)"
               class="w-10 h-10 rounded-xl bg-[#5865F2]/10 border border-[#5865F2]/20 text-[#5865F2]/70 flex items-center justify-center cursor-default select-none shadow-sm">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
